...
export const metadata: Metadata = {
    ...
    description: 'Полное руководство по молитвам для каждого дня недели. Каждый день посвящен определенному архангелу и имеет свои особые молитвы для духовной практики.',
    keywords: 'молитвы по дням недели, ежедневные молитвы, архангелы, духовные практики, православные молитвы',
    openGraph: {
        title: 'Молитвы по дням недели',
